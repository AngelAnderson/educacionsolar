...
const guides: Record<string, Guide> = {
  "como-leer-factura-luma": {
    ...
    content: [
      ...
      { type: "p", text: "Cargo fijo residencial: era $4/mes por estar conectado. Desde el 1 de julio de 2026 es $8/mes, y sube gradualmente hasta ~$16/mes en 2028 (resolución del Negociado de Energía, caso NEPR-AP-2023-0003, 15 abr 2026). Aplica aunque tengas placas." },
  ...
  "incentivos-federales-2026": {
    ...
    content: [
      ...
      { type: "p", text: "La ventana de 'comenzar construcción antes del 4 de julio de 2026' ya cerró. Lo que queda: proyectos que entren EN SERVICIO antes del 31 de diciembre de 2027 pueden reclamar el 30% (IRS Notice 2025-42). Esto es lo que mantiene vivos los leases y PPAs: la compañía dueña del sistema reclama el crédito y puede pasar parte del ahorro al cliente. Ese reloj también está corriendo." },
  ...
  "net-metering-puerto-rico": {
    ...
    content: [
      ...
      { type: "p", text: "La Ley 10-2024 protege el net metering en Puerto Rico: el Negociado no puede ni comenzar el estudio para cambiarlo antes de enero de 2030, y cualquier cambio posterior tarda en aplicar. Garantía práctica mínima hasta 2030-2031." },
      { type: "h2", text: "El pleito que hay que vigilar" },
      { type: "p", text: "La Junta de Supervisión Fiscal demandó al gobierno en el Tribunal Federal (julio 2024) para anular la Ley 10-2024. El caso sigue activo en 2026. Si la Junta gana, el calendario de protección puede cambiar. Hawaii cortó su net metering en 2015 y las instalaciones cayeron ~37% el primer año; California lo recortó en 2023 y las ventas cayeron 66-83%. Eso es lo que está en juego." },
